      ...
      <div className='about-me'>
       <h1>About Me</h1>
        <img className='profile-image' src='makima.jpeg' alt='makima image'  />
          ...
          <p className='desc'>I am Sairaj, a B.Tech student with a strong passion for software development. My expertise spans web technologies and programming languages, including Django, Flask, Python, React.js, MySQL, C++, Java, and C. </p>
